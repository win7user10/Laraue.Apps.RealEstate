...
public sealed class AvitoCrawlingSchemaTests : IAsyncLifetime
{
    ...
    {
        var response = await _page!.GoToAsync("https://www.avito.ru/volgograd/kvartiry/prodam/vtorichka-ASgBAgICAkSSA8YQ5geMUg?cd=1&f=ASgBAQICAkSSA8YQ5geMUgFAkL4NJJSuNZauNQ&s=104&p=1", WaitUntilNavigation.DOMContentLoaded);
